...
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray Activity & \textbf{Rock Climbing (Sport)}\\  %Started outdoors 2019, indoors maybe 2014? off and on
\gray Land & \textbf{Smith Rock, Cascades, Vantage} \hfill \\
\gray Period & \textbf{May 2021 -- Present}\\
&
\vspace{-0.15 cm}
Time to Shower, Peanut Brittle, 5 Gallon Buckets, Stand For Something, Dancer, Birthday Boy, Easy Reader, Amelia Dearheart, Little Book of Lies, The Ragged Edge\\
\\
\end{tabularx}

\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray Activity & \textbf{Splitboarding}\\. %Started in the backcountry March 2020
\gray Land & \textbf{Cascades} \hfill \\
