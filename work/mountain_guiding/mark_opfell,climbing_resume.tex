...
\newline
The Tooth (South Face), Great Northern Slab, Relish Route, Bunny Face
\newline
\newline
...
\newline
Octopus Garden in the Shade, Quarryman, Mourning Star, Coal Train, Wild Turkey, Klahanie Crack, Mouse Trap, Cat Crack
\newline
\\
\end{tabularx}
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
