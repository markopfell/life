...
\textbf{Day Tours}
\newline
Camp Muir, Granite Mountain, East Peak + Cement Basin, Table Mountain circumnavigation, Snow Lake, The Castle
\\
\\
\end{tabularx}
...
%No need to make this fancy it's already a heavy hitter 
 \textbf{Satellites}
 \newline
Kuiper, Echostar XXI, Clarity 1, BlackSky: Gen 3 and Block Two \#4
\\
\end{tabularx}
