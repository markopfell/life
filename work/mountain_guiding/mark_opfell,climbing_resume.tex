...
\textbf{AIARE} \normalfont :
\quad \normalfont Level 2 Recreation, and Rescue \\
\textbf{AMGA} \normalfont :
...
\gray Discipline & \textbf{Splitboard}\\
\gray Lands & Pacific Coast Ranges, Wallowa Mountains, and the Sierra Nevada\hfill \\
\gray Period & 2020 -- Present\\
&
\vspace{-0.15 cm}
\textbf{Overnight Hut or Ski Camping Trips}
\newline
Loch Eileen, Kees and Claire Hut, Mount Nebo, Iron Mountain, Amabalis Mountain
\newline
\newline
\textbf{Day Tours}
\newline
Morrison East Face \& Mono Jim Peak North Face Chute linkup, Mount Saint Helens, Camp Muir, Table Mountain circumnavigation, Cement Basin 
\newline
\end{tabularx}
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
...
\textbf{Glacier \& Snow}
\newline
Mount Rainier (Disappointment Cleaver), Mount Baker (Easton Glacier)
\newline
\newline
\textbf{Rock}
\newline
Cathedral Peak (Southeast Buttress), The Tooth (South Face), Crystal Crag (North Arête)
\newline
%\newline
...
\gray Lands & Pacific Coast Ranges, San Jacinto Mountains, Sierra Nevada, and Dragoon Mountains   \hfill \\
\gray Period & 2021 -- Present\\
&
\vspace{-0.15 cm}
%50 multi-pitch with 10 being grade III or longer
%\newline
\textbf{Trad Multipitch}
\newline
The Squamish Buttress Face, St.Vitus's Dance, Long Time No See, Rambles + Banana Peel linkup, El Whampo, After Six, Ewephoria, White Maiden's Walkway + Fool's Rush linkup, Spirit of Squamish, Skywalker
\newline
...
% \textbf{Satellite Constellations}
 %\newline
%Amazon Leo, Albedo Clarity, BlackSky Gen 3
\\
\end{tabularx}
