...
\newline
Mouse Trap, Cat Crack, First Things First, Master Gardener, Magnet
\newline
\newline
\textbf{Multi-pitch}
...
\textbf{Sport}
\newline
Strategic Placement, 5 Gallon Buckets, Dancer, Birthday Boy\\
\\
\end{tabularx}
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
...
Echostar XXI, Serendipity 1, BlackSky: Gen 3 and Block Two \#4 - \#16, , Echostar 19, ABS-2, YAM-3
\\
\end{tabularx}
