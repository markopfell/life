...
Certifications & AMGA Alpine Skills Course, Wilderness First Responder / CPR \\
& AIARE I and Rescue, Leave No Trace Trainer\\
\end{tabular}
...
\newline
Wild Turkey, Mouse Trap, Cinnamon Slab, Cat Crack, Corner Flash, Open Book, On Second Thought, First Things First, Journey to the Other Side of the Bridge
\newline
\newline
\textbf{Multi-pitch}
%50 multi-pitch with 10 being grade III or longer
\newline
Great Northern Slab, Relish Route, Bunny Face
\newline
\\
\end{tabularx}
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
...
Echostar XXI, Serendipity 1, BlackSky: Gen 3 and Block Two \#4 , Echostar 19, ABS-2, YAM-3
\\
\end{tabularx}
