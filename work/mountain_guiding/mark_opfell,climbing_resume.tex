...
Certifications & Wilderness First Responder, Avalanche Level I and Rescue, CPR,\\
...
\gray Land & \textbf{Canada, Washington, Oregon} \hfill \\
\gray Period & \textbf{May 2021 -- Present}\\
&
\vspace{-0.15 cm}
\textbf{Trad}
% SPI = "15 trad climbs any grade "
%SPI Exam = "You have led a minimum of 40 traditional routes, most of which should be 5.6 and on a variety of rock types"
%Apprentice rock exam = lots of trad climbs 5.9 and ten 5.10s
\newline
Mouse Trap, Cat Crack, First Things First, Magnet
\newline
\newline
\textbf{Multi-pitch}
...
\textbf{Sport}
\newline
Strategic Placement, 5 Gallon Buckets, Dancer, Birthday Boy, 9999\\
\\
\end{tabularx}
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
...
&
\vspace{-0.15 cm}
Camp Muir, Loch Eileen, Granite Mountain, Snow Lake, East Peak, Jim Hill Mountain, Blue Bell Peak, Herman Saddle, Arrowhead Mountain
\\
\\
\end{tabularx}
...
Echostar XXI, Albedo-1, BlackSky: Gen 3 and Block Two \#4 - \#16, , Echostar 19, ABS-2, YAM-3
\\
\end{tabularx}
