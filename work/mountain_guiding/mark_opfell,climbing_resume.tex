...
Certifications & Avalanche Level I\\
\\
\end{tabular}
...
\gray Activity & \textbf{Mountaineering \& Ice Climbing}\\
\gray Land & \textbf{Cascades} \hfill \\
\gray Period & \textbf{September 2019 -- Present}\\
&
\vspace{-0.15 cm}
Mount Rainier (guided by Alpine Ascents), Mount Adams (solo), Mount Baker (guided by Alpine Ascents),  Mount Helens (solo), Coleman Ice Fall AI2 [TR] (guided by Kaf Adventures) 
\\
\\
\end{tabularx}
...
\gray Land & \textbf{Smith Rock} \hfill \\
\gray Period & \textbf{May 2021 -- Present}\\
&
\vspace{-0.15 cm}
Time to Shower, Peanut Brittle, 5 Gallon Buckets, Stand For Something, Dancer, Easy Reader, Amelia Dearheart, 9999\\
\\
\end{tabularx}
...
&
\vspace{-0.15 cm}
Echostar 21, BlackSky Globals \#4 - \#16, Echostar 19, ABS-2, YAM-3
\\
\end{tabularx}
