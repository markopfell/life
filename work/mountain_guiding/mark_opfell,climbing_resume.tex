...
&
\vspace{-0.15 cm}
Mount Rainier (guided by Alpine Ascents), Mount Adams (solo), Mount Baker (guided by Alpine Ascents),  Mount Helens: solo, mock guide
\\
\\
\end{tabularx}
...
&
\vspace{-0.15 cm}
Echostar XXI, BlackSky: Gen 3, Block Two \#4 - \#16, Albedo-1, Echostar 19, ABS-2, YAM-3
\\
\end{tabularx}
