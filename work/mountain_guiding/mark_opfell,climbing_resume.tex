...
\gray Land & \textbf{British Columbia, Washington, Oregon} \hfill \\
...
\newline
Mouse Trap, Cinnamon Slab, Cat Crack, First Things First, Ring Pin Crack, Open Book, Edge of Mistakes, Master Gardener, Right Slab Crack, Magnet
\newline
\newline
\textbf{Multi-pitch}
%50 multi-pitch with 10 being grade III or longer
\newline
Bunny Face, Relish Route
\newline
\\
\end{tabularx}
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
