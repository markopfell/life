...
\gray Land & \textbf{Pacific Coast Ranges, the Sierra Nevada, and Dragoon Mountains} \hfill \\
\gray Period & \textbf{May 2021 -- Present}\\
&
\vspace{-0.15 cm}
\textbf{Multi-pitch Trad}
%50 multi-pitch with 10 being grade III or longer
\newline
Cathedral Peak (Southeast Buttress), The Tooth (South Face), After Six, Ewephoria, Skywalker, Warpath, Great Northern Slab, Four Course Meal, Swan Slab Gully, Zig Zag
\newline
%\newline
...
&
\vspace{-0.15 cm}
Camp Muir, Loch Eileen, Granite Mountain, Snow Lake, Iron Mountain, East Peak, Jim Hill Mountain, The Castle, Blue Bell Peak, Herman Saddle
\\
\\
\end{tabularx}
