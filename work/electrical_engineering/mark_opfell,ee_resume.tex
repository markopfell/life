...
&
\vspace{-0.15 cm}
Creating, evaluating, and building space-to-ground digital communications links. Developing the mission data chain from modulated waveform to frames, packets, and connections. Evaluating with a schedule, GNU Radio python code, physical software defined transceivers, technical deep dives into open source communication standards, collaboration on product (satellite imagery) level vision, and merging dev code to the processing pipeline.
\newline
\newline
Leading FCC and ITU regulatory analysis and filing effort.
\newline
\newline
From a blank slate designing and procuring: facility RF testing flow, FlatSat communication strategy with associated hardware and software, RF test equipment, and ground station RF and software stack.
%\newline
%\newline
%Continuously building consensus with the founders: CEO, CTO, and CPO, on which space and ground communication business partnerships to pursue. 
%\newline
%\newline
