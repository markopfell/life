...
Standards & CCSDS, DVB-S2, ITU, FCC, IRIG\\
...
&
\vspace{-0.15 cm}
Hands-on debugged a software defined transmitter Xilinx FPGA digital modulator, and frame synchronizer.  Corrected, committed, and re-built high-level HDL generating code reversing a subtle endianness swap, and non-standard synchronization words.  Flashed the output bitstreams onto PCBAs, and validated bit accuracy and frame lock with commercial.
Wrote, and tested high-level HDL generating code pseudo-randomization algorithm proving demodulator lock, and basic spectral compliance.   
%Networked, built, programmed, and tested RF HITL rack testing S-band telemetry-over-IP bit error rate from vehicle UDP/IP multicast network traffic to radiated PSK waveform received by the ground receiver.
%Hands-on debugged a Xilinx FPGA radio’s digital frame synchronizer.  Fixed major errors in high level HDL, and flashed working bitstreams onto PCBAs. 
\newline
%\newline
%\newline
\end{tabularx}
