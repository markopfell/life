...
Networking & Ethernet, UDP, TCP/IP, iPerf, Wireshark, Ethernet\\ %Blacksky, Leostella public knowledge 
...
&
\vspace{-0.15 cm}
Developing real time rocket telemetry system for first flight safety.
\newline
...
Built, and ran bare metal UDP/IP throughput experiments on a FPGA.  Developed a Python driver capturing raw telemetry frames of RSSI on Gateway LNBs, and coupled RF transmit power from BUCs.  The Python driver could reboot individual gateway hardware and reverse faults. 
\newline
%Developed and tested Ka-band payload phased array system antenna  test matrix in a spacecraft sized anechoic chamber.
%\newline
%\newline
