...
RF Standards & ITU, FCC, DVB-S2, VITA49 \\
Groundstation Network & KSAT Lite\\
Software Tools & Python, Git*, Bash, Excel (Wizard), Vi\\
Mathematical Python Librarys & NumPy, SciPy, Matplotlib, Pandas \\
Hardware Tools & VNA, Antenna Hats, SDR\\
...
%WORK EXPERIENCE
%Running total = 9 years + 10 months as of 3/1/22022
...
%total yearly compensation:$175k + 50,000 stock, company_size=12
&
\vspace{-0.15 cm}
Designing space-to-ground communication systems in collaboration with mission and ground software architects capable of delivering 10 cm satellite imagery to anyone with an internet connection and a credit card.	
\newline
\newline
Created a realistic and actionable plan to increase satellite constellation average payload data throughput by 42\% with minimal cost, schedule, and risk through large scale link budget modeling and systems engineering.
\newline
\newline
Building consensus with the CEO and CTO to pursue strategic business partnerships tying to crucial technical solutions. 
%\newline
%\newline
