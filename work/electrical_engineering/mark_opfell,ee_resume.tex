...
Python Libraries & NumPy, SciPy, Matplotlib, Scapy\\
Cloud & AWS, Azure \\ %Blacksky, Leostella public knowledge 
Significant Ascents & Mount Rainier, Stawamus Chief (Squamish Buttress face)\\%, 5 Gallon Buckets \\
%Significant Descents & Camp Muir (Winter), Skykomish (Class III+) \\ 
\\
\end{tabular}

%WORK EXPERIENCE
%Running total = 11 years + 1 months as of 8/1/2024
