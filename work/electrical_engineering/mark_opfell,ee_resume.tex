...
Significant Volcano Ascents & Mount Rainier, Mount Adams (solo)\\%, 5 Gallon Buckets \\
...
&
\vspace{-0.15 cm}
Creating, evaluating, and documenting space-to-ground communications and the mission data chain from physical to presentation layers. Evaluation methods include GNU Radio software defined transceiver simulations, technical deep dives into open source communication standards, and cross-team collaboration on product level (satellite imagery) vision, and processing pipeline codebase.
\newline
\newline
