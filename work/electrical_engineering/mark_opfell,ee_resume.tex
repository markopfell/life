...
\newline
\newline
Leading FCC and ITU regulatory filing and RF analysis effort.
\newline
\newline
Designing and procuring from scratch: facility RF testing flow, FlatSat communication strategy with associated hardware and software, RF test equipment, and ground station RF and software stack.
\newline
\newline
