...
Significant Volcano Ascents & Mount Rainier, Mount Adams\\%, 5 Gallon Buckets \\
...
%total yearly compensation:$181,330.72 + 100,000 stock valued at $3/share, company_size=12
&
\vspace{-0.15 cm}
Creating, evaluating, and documenting space-to-ground communications and the mission data chain: bit, frame, and packet levels. Evaluation methods include GNU Radio software defined transceiver simulations, technical deep dives into open source communication standards, and cross-team discussion of product level (satellite imagery) requirements.
\newline
\newline
Created a realistic and actionable plan to increase satellite constellation average payload data throughput by 42\% yielding a 14\% increase in capacity (directly correlated with revenue).  Validated the plan with large scale year-in-the-life Python link budget modeling and systems engineering showing minimal schedule delay, and technical risk.  Continously building consensus with the founders: CEO, CTO, and CPO, on which space and ground communication business partnerships to pursue. 
%\newline
%\newline
