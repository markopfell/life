...
\newline
\newline
Procured, set up, coded, documented, and maintained FlatSat (hardware-in-the-loop) S-band TT\&C (telemetry \& command) megabit speed links with test equipment, and ground station hardware + software stack.  Defined and tested first contact ConOps. Architected and built out facility RF testing flow, and lab-to-cloud remote VPN network. 
\newline
\newline
%\newline
%\newline
