...
&
\vspace{-0.15 cm}
Creating, evaluating, and building space-to-ground digital communications links.  Developing the mission data chain from modulated waveform to frames, packets, and end-to-end UDP connections. Evaluating with GNU Radio, software defined transceivers, technical deep dives into open source communication standards, collaboration on product (satellite imagery) level vision, and merging dev code to the processing pipeline.
\newline
\newline
