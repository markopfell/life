...
\newline
\newline
Leading FCC and ITU regulatory filing and RF analysis efforts.
\newline
\newline
Designing and procuring from scratch with strong open source focus: facility RF testing flow, FlatSat communication strategy with test equipment, and ground station hardware \& software stack.
\newline
\newline
Continuously building consensus with the founders (CEO and CTO) on which space and ground communication business partnerships to pursue. 
%\newline
%\newline
