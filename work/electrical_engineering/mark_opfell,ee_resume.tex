...
Standards & DVB-S2, CCSDS, IRIG, FCC, ITU\\
...
Networking & Ethernet, UDP, TCP, IP, Wireshark, iPerf\\ %Blacksky, Leostella public knowledge 
%Cloud & AWS EC2 \& S3\\ %Blacksky, Leostella public knowledge 
FPGA & Xilinx Zynq, PYNQ, Vivado\\
...
&
\vspace{-0.15 cm}
Developing real time rocket telemetry systems for first flight safety.
\newline
%Developed and tested Ka-band payload phased array system antenna  test matrix in a spacecraft sized anechoic chamber.
%\newline
%\newline
\end{tabularx}
...
Built, and ran UDP/IP throughput experiments on a Xilinx Zynq FPGA.  Developed a Python driver capturing raw telemetry frames of RSSI on Gateway LNBs, and coupled RF transmit power from BUCs.  The Python driver could reboot individual gateway hardware and reverse faults. 
\newline
%Developed and tested Ka-band payload phased array system antenna  test matrix in a spacecraft sized anechoic chamber.
%\newline
%\newline
