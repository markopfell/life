...
Standards & DVB-S2, CCSDS, IRG, Ethernet, FCC, ITU\\
...
Networking & UDP/IP, iPerf, Wireshark\\ %Blacksky, Leostella public knowledge 
...
Built, and ran UDP/IP throughput experiments on a bare metal FPGA.  Developed a Python driver capturing raw telemetry frames of RSSI on Gateway LNBs, and coupled RF transmit power from BUCs.  The Python driver could reboot individual gateway hardware and reverse faults. 
\newline
%Developed and tested Ka-band payload phased array system antenna  test matrix in a spacecraft sized anechoic chamber.
%\newline
%\newline
