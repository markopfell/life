...
\newline
\newline
Created a realistic and actionable plan to increase satellite constellation average payload data throughput by 42\% yielding a 13.7\% increase in capacity (directly correlated with revenue).  Validated the plan with large scale year-in-the-life link budget modeling and systems engineering both showing minimal: recurring cost, schedule delay, and technical risk.
\newline
\newline
