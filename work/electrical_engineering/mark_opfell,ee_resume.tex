...
Volcano Ascents &  Rainier/Disappointment Cleaver,  Baker/Coleman Glacier \\%Stawamus Chief (Squamish Buttress face), 5 Gallon Buckets \\
...
&
\vspace{-0.15 cm}
Architected, developed, and programmed RF HITL rack (hardware-in-the-loop) testing S-band telemetry bit and packet error rate of the mission data chain from vehicle UDP/IP multicast network traffic to radiated QPSK waveform received by the ground FPGA-based SDR.
\newline
%\newline
%\newline
\end{tabularx}
