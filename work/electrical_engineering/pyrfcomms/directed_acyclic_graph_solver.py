# A couple of ideas:
# Caudill's ideas: spreadsheet can be thought of as a directed acyclic graph and thus a link budget
# Glass's idea: Link budgets have statistical distributions and time varying features
# My idea:  represent a link budget as a Bayesian Network ~= a directed probabilistic graph model
# Note: This differs from a Markov Network as perhaps the movement along the graph is non-random
