...
&
\vspace{-0.15 cm}
%Hands-on debugged a Xilinx FPGA-based software defined transmitter's digital modulator, and frame synchronizer.  Corrected, committed, and re-built high-level code generating HDL reversing a subtle endianness swap, and non-standard synchronization words.  Flashed bitstreams onto PCBAs, and validated system bit accuracy, and frame lock.
Networked, programmed, built, and tested RF HITL rack routing S-band telemetry-over-IP from space rocket UDP/IP multicast network traffic to radiated PSK waveform received by the ground receiver.
\newline
\newline
Wrote, and tested high-level code generating HDL for a pseudo-randomization algorithm proving basic spectral compliance.   
Hands-on debugged a Xilinx FPGA software defined transmitter's digital frame synchronizer fixing major errors in high level HDL.
