...
\setkomavar{subject}{Cover Letter for Open Call (Communications Engineer)} % Bold text above the letter specifying what it's for, useful for specifying the job you are applying for. Leave this empty for no subject.
