...
HW Tools & Digital Receiver, Spectrum Analyzer, Antenna Hats \\
SW Tools & Pycharm, Vi, Bash, Git, GitHub, Excel (Wizard)\\
Python Stack & NumPy, SciPy, Matplotlib, Json, Requests \\
...
\newline
\newline
Designed, sourced, assembled, and validated ground station test hardware in conjunction with the software team providing an end-to-end solution.
\newline
\newline
