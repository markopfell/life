...
Tools & Pycharm, Vi, Bash, Git, GitHub\, Jupyter, Docker\\
APIs \& Standards & FCC, ITU, REST, JSON,  \\
Databases & PostgreSQL, MongoDB \\
Life & Financial Independence, Backcountry skiing\\
\\
\end{tabular}
...
\gray Job Title & \textbf{Systems Engineer}\\
...
&
\vspace{-0.15 cm}
RF systems designer developing on a network of mobile software defined phased array antennas connecting users to the Internet over satellite.  Kymeta is a Series D startup funded by Bill Gates.
\\
\\
\end{tabularx}

\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray Job Title & \textbf{Systems Software Engineer}\\
...
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray Job Title & \textbf{Senior Systems Engineer}\\
\gray Employer & \textbf{Space Systems/Loral} \hfill Mountain View, CA\\
