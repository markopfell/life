...
Life & Ski Mountaineering, Wealth Management  \\
\\
\end{tabular}
...
\newline
\newline
LEO constellations currently include an imaging platform for BlackSky with 4 in-orbit and a total of 60 planned, as well as proposal work for Spacebelt (a space-based secure cloud storage)
\\
\\
\end{tabularx}
...
&
\vspace{-0.15 cm}
Developed and executed over-the-air combined OSI application, transport, network, and physical layer level test cases for a MIMO terminal Ku-band ground station with software defined electronically scanned antennas.
\newline
\newline
