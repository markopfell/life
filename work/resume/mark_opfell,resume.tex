...
&
\vspace{-0.15 cm}
Architecting software defined radio RF communications system solutions for low-earth orbit small satellite constellations (BlackSky \& Loft Orbital) managing cost, size, weight, schedule, and risk.  Built Python link budget model to simulate: throughput, coverage, power, and bandwidth.
\newline
\newline
