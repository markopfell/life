...
Significant Ascents & Mount Rainier, Mount Adams, Mount Baker
\\
\end{tabular}
...
&
\vspace{-0.15 cm}
Architecting software defined RF communications system solutions for low-earth orbit small satellite constellations (BlackSky \& Loft Orbital) managing cost, SWaP, schedule, and risk.  Building an open source link budget model to simulate: throughput, coverage, power, and bandwidth.
\newline
\newline
