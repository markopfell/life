...
&
\vspace{-0.15 cm}
Architecting digital software defined radio RF communications system solutions for low-earth orbit small satellite constellations.  Performing link budget multivariate optimizations for: cost, size, weight, power, data rate, spectrum, schedule, and risk.
\newline
\newline
...
&
\vspace{-0.15 cm}
Developed and executed over-the-air combined OSI application, transport, network, and physical layer level test cases for a mobile MIMO terminal Ku-band ground station with software defined electronically scanned flat panel antennas and a DVB-S2 satellite modem
\newline
\newline
