...
&
\vspace{-0.15 cm}
Architecting digital software defined radio RF communications system solutions for low-earth orbit small satellite constellations.  Performing link budget multivariate optimizations for: cost, size, weight, power, bit error rate, occupied bandwidth, and spectral efficiency.
\newline
\newline
