...
&
\vspace{-0.15 cm}
Developed and executed over-the-air combined OSI application, transport, network, and physical layer level test cases for a MIMO terminal Ku-band ground station with software defined electronically scanned antennas and a DVB-S2 satellite modem
\newline
\newline
