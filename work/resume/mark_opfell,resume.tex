...
&
\vspace{-0.15 cm}
Architecting and collaborating with suppliers and customers to design, manufacture, test, launch, and operate multi-band space-to-ground software defined RF communications system solutions for low-earth orbit small satellite constellations (BlackSky, Loft Orbital, NorthStar Earth \& Space) while managing cost, schedule, risk, and SWaP.
\newline
\newline
Flowed top-level GPS RF system self-compatibility requirements to a filter design. Implemented design by researching, simulating, and purchasing parts, laying out the RF section on a mixed signal PCB.  Validated and characterized calibrated RF response with a network analyzer over temperature extremes. Successful in-orbit operation.
%\newline
%\newline
