...
\definecolor{appetizercolor}{rgb}{0.5,0.2,0.1}
...
\recipe[Without a wood fired grill, broiling tomatoes, onions, and peppers converts starchy carbohydrates into sweeter sugars.  Additionally the infrared heat wonderfully chars imparting a mild smokey flavor to the sauce.]{Roja Salsa v15}[]
%\serves{6-8}
%\preptime{1 hour}
%\cooktime{1 hour}
% \dishtype{\dessert}
